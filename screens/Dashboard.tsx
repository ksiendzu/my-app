...
const Dashboard = ({ navigation }:any) => {
    ...
    const renderCountries=()=>{
        return (
            ...
            onMomentumScrollEnd={(event) => {
                ...
                setPlaces([
                    { id: -1 },
                    ...dummyData.countries[(position as any)].places,
                    { id: -2 }
                ])
            }}
    ...
    // function exploreButtonHandler() {
        ...
        const currentIndex = parseInt((placesScrollPosition as any), 10) + 1
    ...
    const renderPlaces=()=>{
        return(
            ...
            onMomentumScrollEnd={(event) => {
                ...
                setPlacesScrollPosition(position as any)
            }}
            renderItem={({item,index})=>{
                ...
                if(index == 0 || index == places.length - 1) {
                    ...
                    >
                        ...
                        >
                            <Text style={{marginBottom: SIZES.radius, color: COLORS.white, ...FONTS.h1}}>{(item as any)?.name}</Text>

                            <Text style={{marginBottom: SIZES.padding * 2, textAlign: 'center', color: COLORS.white, ...FONTS.body3}}>{(item as any)?.description}</Text>
